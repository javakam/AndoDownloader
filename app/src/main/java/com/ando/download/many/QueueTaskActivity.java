...
public class QueueTaskActivity extends AppCompatActivity {
    ...
    public static final String DOWNLOAD_FILE_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/manytest";

    private RecyclerView mRvTasks;
    private QueueTaskAdapter mAdapter;
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new QueueTaskAdapter(controller);
